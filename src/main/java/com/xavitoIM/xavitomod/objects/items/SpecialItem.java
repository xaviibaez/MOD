package com.xavitoIM.xavitomod.objects.items;

import java.util.List;

import com.xavitoIM.xavitomod.init.BlockInit;
import com.xavitoIM.xavitomod.util.helpers.KeyboardHelper;
...
public class SpecialItem extends Item{
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		if(KeyboardHelper.isHoldingShift()){
			tooltip.add(new StringTextComponent("Test Information - IF"));
		}
		else {
			tooltip.add(new StringTextComponent("Test Information - ELSE- Hold shift for more info"));
		}
